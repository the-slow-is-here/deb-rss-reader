...
const TX: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'empty.welcome': 'Start reading — add a feed from the sidebar or pick one below',
    'empty.orPick': 'Or pick a suggested feed to get started:',
    ...
    'summary.count': '{feeds} feeds · {count} articles',
    'summary.searchCount': 'Search · {feeds} feeds · {count} articles',
    'summary.dateCount': 'Date range · {feeds} feeds · {count} articles',
    'summary.searchDateCount': 'Search + date · {feeds} feeds · {count} articles',
    ...
    // Guest
    'guest.loginButton': 'Continue without an account',
    'guest.infoBanner': "You're in guest mode",
    'guest.infoLink': 'Create a free account to unlock full features.',
    'guest.limitTitle': 'Guest Limit Reached',
    'guest.limitMessage': 'Free accounts can subscribe to up to 3 feeds. Create an account to add unlimited feeds.',
    'guest.limitSignUp': 'Create Account',
    'guest.starTitle': 'Feature Locked',
    'guest.starMessage': 'Starring feeds is available for registered users. Create a free account to star feeds and unlock more features!',
    'guest.playlistTitle': 'Playlists Locked',
    'guest.playlistMessage': 'Playlists let you organize feeds into groups. Create a free account to use this feature!',
    'guest.playlistsLocked': 'Playlists are available for registered users only.',
    'guest.settingsLocked': 'Email digests are available for registered users only.',
    'guest.upsellBanner': 'Unlock playlists, email digests & unlimited feeds',
    'guest.upsellButton': 'Create Account',
    'guest.convertHeading': 'Complete Your Account',
    'guest.convertButton': 'Create Account',
    'guest.convertSuccess': 'Account created! Your feeds are saved.',
    'dismiss': 'Dismiss',
    'suggestedFeeds.title': 'Try adding a feed',
    'suggestedFeeds.add': 'Add',
  },
  ...
  ar: {
    ...
    'empty.welcome': 'ابدأ القراءة — أضف مصدراً من القائمة الجانبية أو اختر أحد المصادر أدناه',
    'empty.orPick': 'أو اختر مصدراً مقترحاً للبدء:',
    ...
    'summary.count': '{feeds} مصادر · {count} مقالات',
    'summary.searchCount': 'بحث · {feeds} مصادر · {count} مقالات',
    'summary.dateCount': 'نطاق التاريخ · {feeds} مصادر · {count} مقالات',
    'summary.searchDateCount': 'بحث + تاريخ · {feeds} مصادر · {count} مقالات',
    ...
    // Guest
    'guest.loginButton': 'متابعة بدون حساب',
    'guest.infoBanner': 'أنت في وضع الضيف',
    'guest.infoLink': 'أنشئ حساباً مجانياً لفتح جميع الميزات.',
    'guest.limitTitle': 'تم الوصول إلى الحد الأقصى',
    'guest.limitMessage': 'الحسابات المجانية يمكنها الاشتراك في ٣ خلاصات فقط. أنشئ حساباً لإضافة خلاصات غير محدودة.',
    'guest.limitSignUp': 'إنشاء حساب',
    'guest.starTitle': 'الميزة مقفلة',
    'guest.starMessage': 'تنجيم الخلاصات متاح للمستخدمين المسجلين فقط. أنشئ حساباً مجانياً لتنجيم الخلاصات وفتح المزيد من الميزات!',
    'guest.playlistTitle': 'قوائم التشغيل مقفلة',
    'guest.playlistMessage': 'قوائم التشغيل تتيح لك تنظيم الخلاصات في مجموعات. أنشئ حساباً مجانياً لاستخدام هذه الميزة!',
    'guest.playlistsLocked': 'قوائم التشغيل متاحة للمستخدمين المسجلين فقط.',
    'guest.settingsLocked': 'ملخصات البريد الإلكتروني متاحة للمستخدمين المسجلين فقط.',
    'guest.upsellBanner': 'افتح قوائم التشغيل وملخصات البريد الإلكتروني وخلاصات غير محدودة',
    'guest.upsellButton': 'إنشاء حساب',
    'guest.convertHeading': 'أكمل حسابك',
    'guest.convertButton': 'إنشاء حساب',
    'guest.convertSuccess': 'تم إنشاء الحساب! تم حفظ خلاصاتك.',
    'dismiss': 'تجاهل',
    'suggestedFeeds.title': 'جرّب إضافة مصدر',
    'suggestedFeeds.add': 'إضافة',
  },
};
